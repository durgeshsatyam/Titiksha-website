...
<head>
	...
	<title>Titiksha 2015-2016</title>
</head>
<body>
	...
	<main>
		<section class="cd-section index cd-selected">
			...
			<iframe src="home/home.html" height="100%" width="100%"  scrolling="yes" overflow : "hidden" ></iframe>
